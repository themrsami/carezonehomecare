...
export default function Home() {
  return (
    <section className="relative bg-[#1D232A] pb-12 md:pb-24">
        ...
        <div className="relative py-16 pb-20 xs:pb-40 md:pb-72 px-2 xs:px-8 bg-gray-800 rounded-3xl overflow-hidden">
          <div className="relative max-w-lg lg:max-w-3xl mb-14 mx-auto text-center">
            <div className="max-w-lg md:max-w-2xl px-4 mx-auto">
              ...
              <p className="max-w-lg mx-auto text-lg text-gray-300 mb-10">At CareZone, we provide personalized home health services. Our dedicated team is committed to improving your well-being in a nurturing environment.</p>
