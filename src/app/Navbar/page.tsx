  ...
  return (
    <div className="navbar bg-gray-900">
        <div className="navbar-start">
            ...
            <Link href="/">
                <Image className="mb-7" src="/logo.webp" alt="Logo" width={50} height={100} />
            </Link>
        </div>
        <div className="navbar-center hidden lg:flex">
            <ul className="flex justify-center">
                <Link href="/"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Home</li></Link>
                <Link href="/About"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">About</li></Link>
                <Link href="/SpecialOffers"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Special Offers</li></Link>
                <Link href="/Services"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Services</li></Link>
                <Link href="/Blog"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Blog</li></Link>
                <Link href="/FAQs"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">FAQs</li></Link>
                <Link href="/OurTeam"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Our Team</li></Link>
                <Link href="/ContactUs"><li className="btn btn-ghost rounded-btn text-pink-100 text-lg">Contact Us</li></Link>
            </ul>
        </div>
